    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <FadeInView delay={700} fromY={30} duration={480}>
          <AnimatedPressable style={styles.button} onPress={() => navigation.navigate('Assessment')}>
            <Text style={styles.buttonText}>Start Session</Text>
          </AnimatedPressable>
        </FadeInView>

        {/* ── Secondary buttons ────────────────────────── */}
        <FadeInView delay={820} fromY={24} duration={460} style={styles.buttonRow}>
          <AnimatedPressable style={styles.halfButton} onPress={() => navigation.navigate('Challenge')}>
            <Text style={styles.halfButtonIcon}>{'\uD83D\uDD25'}</Text>
            <Text style={styles.halfButtonText}>Challenge</Text>
          </AnimatedPressable>
          <AnimatedPressable style={styles.halfButton} onPress={() => navigation.navigate('Progress')}>
            <Text style={styles.halfButtonIcon}>{'\uD83D\uDCCA'}</Text>
